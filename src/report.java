...
//        l.getColumn(4).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_business_report_100px.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Membership ID", "Mmeber Name", "Book ID", "Book Name", "Borrow Date", "Return Date"
            }
        ) {
   ...
   Functions f;
    ...
    private void history(){
        ArrayList<bookLogs> borr=new ArrayList<>();
        borr=f.getB_logs();
        for(int i=0;i<borr.size();i++){
            Members m=f.search_member_by_ID(borr.get(i).getM_ID());
            Book b=f.book_search_by_ID(borr.get(i).getB_ID());
            model.insertRow(model.getRowCount(), new Object[]{(i+1),borr.get(i).getM_ID(),m.getName(),borr.get(i).getB_ID(),b.getName(),borr.get(i).getB_date(),borr.get(i).getR_date()});
        }
    }
