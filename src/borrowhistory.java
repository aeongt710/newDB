 ...
 * @author AHMAD
 */
public class borrowhistory extends javax.swing.JFrame {
...
//        l.getColumn(4).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_order_history_100px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Borrow History");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Membership ID", "Mmeber Name", "Book ID", "Book Name", "Borrow Date"
            }
        ) {
   ...
   Functions f;
    ...
    private void history(){
        ArrayList<Borrowed> borr=new ArrayList<>();
        borr=f.getBorrow();
        for(int i=0;i<borr.size();i++){
            Members m=f.search_member_by_ID(borr.get(i).getMemID());
            Book b=f.book_search_by_ID(borr.get(i).getBookID());
            model.insertRow(model.getRowCount(), new Object[]{(i+1),borr.get(i).getMemID(),m.getName(),borr.get(i).getBookID(),b.getName(),borr.get(i).getDate()});
        }
    }
